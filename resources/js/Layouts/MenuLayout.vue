...
<template>
    ...
    <div class="min-h-screen bg-[#2D5522] ">
        ...
        <div class="min-h-screen bg-gray-50 pt-5">
          ...
          <div class="md:text-right me-20">
            ...
            <section class="px-6 py-10">
                <div class="space-y-10">
                  <!-- Category: Holiday Limited Edition -->
                  <div>
                    <h2 class="text-3xl font-bold text-green-600">Holiday Limited Edition</h2>
                    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" >
                      <div v-for="product in holidayProducts" :key="product.id" class="bg-gray-100 rounded-lg p-4 text-center shadow-md" style="background-image: url('right.gif'); 
                      background: cover; background-repeat: no-repeat;">
                        ...
                        <button class="mt-2 w-full py-1 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700">Add to Cart</button>
                      </div>
                    </div>
                  </div>
                  ...
                  <!-- Category: Latte -->
                  <div>
                    <h2 class="text-3xl font-bold text-green-600">Latte</h2>
                    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                      <div v-for="product in latteProducts" :key="product.id" class="bg-gray-100 rounded-lg p-4 text-center shadow-md">
                        <img :src="product.image" alt="product.name" class="h-32 mx-auto mb-2">
                        <h3 class="text-lg font-semibold">{{ product.name }}</h3>
                        <p class="text-gray-500">₱{{ product.price }}</p>
                        <button class="mt-2 w-full py-1 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700">Add to Cart</button>
                  ...
                  <!-- Category: Coffee -->
                  <div>
                    <h2 class="text-3xl font-bold text-green-600">Cold</h2>
                    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                      <div v-for="product in coffee" :key="product.id" class="bg-gray-100 rounded-lg p-4 text-center shadow-md">
                        <img :src="product.image" alt="product.name" class="h-32 mx-auto mb-2">
                        <h3 class="text-lg font-semibold">{{ product.name }}</h3>
                        <p class="text-gray-500">₱{{ product.price }}</p>
                        <button class="mt-2 w-full py-1 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700">Add to Cart</button>
                  ...
                  <div>
                    <h2 class="text-3xl font-bold text-green-600">Premium-Roast</h2>
                    <div class="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                      <div v-for="product in premium" :key="product.id" class="bg-gray-100 rounded-lg p-4 text-center shadow-md">
                        <img :src="product.image" :alt="product.name" class="h-32 mx-auto mb-2">
                        <h3 class="text-lg font-semibold">{{ product.name }}</h3>
                        <p class="text-gray-500">₱{{ product.price }}</p>
                        <button class="mt-2 w-full py-1 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700">Add to Cart</button>
