                ...
                <div class="flex h-16 justify-between items-center">
                    <div class="flex ">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                            <NavLink :href="route('dash')">HOME</NavLink>
                            <div class="relative group border-b-2 border-transparent hover:border-gray-300">
                              ...
                              <div
                                  ...
                                  <DropdownLink href="#latte">Latte</DropdownLink>
                                  <DropdownLink href="#cold">Cold</DropdownLink>
                                  <DropdownLink href="#premium">Premium Roast</DropdownLink>
                              </div>
                            </div>
